/**
 * 从目标编辑器或工作区读取书签、顺序和显示范围，形成尚未对外发布的视图快照。
 * 准备阶段允许取消且不修改当前界面，只有完整快照才会交给提交器。
 */
...
export interface PreparedBookmarkView extends BookmarkViewTarget {
	...
	workspaceLayoutFilePath?: string
	workspaceLayoutNeedsPersist: boolean
	workspaceLayoutWriteBlocked: boolean
