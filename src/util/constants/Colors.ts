...
export class Colors {
	static readonly prefix = 'codebookmark.color.'
	...
	static readonly Lvl1Orange = {
		id: this.prefix + 'Lvl1Orange',
		defaults: { dark: '#f76f53', light: '#f76f53' },
		description: "Level 1 Bookmark Orange",
	}

	static readonly Lvl2Blue = {
		id: this.prefix + 'Lvl2Blue',
		defaults: { dark: '#24acf2', light: '#24acf2' },
		description: "Level 2 Bookmark Blue",
	}
