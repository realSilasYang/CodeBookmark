...
${iconSemanticCatalog}`,
	...
	'commands.bookmarkCommands.bookmarkConfigurationImportWasCancelled': 'Đã hủy nhập cấu hình dấu trang.',
	'commands.bookmarkCommands.failedToImportBookmarkConfiguration': 'Không thể nhập cấu hình dấu trang: {errorMessage}',
	...
	'commands.exportCommand.bookmarkConfigurationSource': 'Tệp nguồn cấu hình dấu trang',
	'commands.exportCommand.bookmarkConfigurationSourceExportCompletedFilesSucceededExportedFolder': 'Đã xuất tệp nguồn cấu hình dấu trang: thành công {exported} tệp{failedText}; kết quả: {formatBookmarkLevelSummary}; thư mục: {fileName}.',
	'commands.exportCommand.bookmarkConfigurationSourceFileNotFound': 'Không tìm thấy tệp nguồn cấu hình dấu trang',
	...
	'commands.exportCommand.codebookmarkConfigurationSources': 'CodeBookmark-Tệp nguồn cấu hình dấu trang',
	...
	'commands.exportCommand.failedToExportBookmarkConfigurationSources': 'Không thể xuất tệp nguồn cấu hình dấu trang: {errorMessage}',
	'commands.exportCommand.fileLineColumnLevelStatusLabelCode': 'Tệp,Dòng,Cột,Cấp,Trạng thái,Nhãn,Nội dung mã',
	'commands.exportCommand.filesFailed': ', {failed} tệp xuất thất bại',
	...
	'commands.exportCommand.noneOfTheConfigurationSourceFilesForTheCurrent': 'Mọi tệp nguồn cấu hình của các dấu trang hiện tại đều không tồn tại hoặc không đọc được.',
	...
	'commands.exportCommand.selectAFolderForBookmarkConfigurationSources': 'Chọn thư mục xuất tệp nguồn cấu hình dấu trang',
	...
	'commands.exportCommand.thereAreNoBookmarkConfigurationSourceFilesToExport': 'Không có tệp nguồn cấu hình dấu trang để xuất.',
	...
	'providers.BookmarkImportWorkflowRunner.anEntireBookmarkConfigurationFolderCanOnlyBeImported': 'Chỉ chế độ không gian làm việc mới có thể nhập cả thư mục cấu hình dấu trang.',
	'providers.BookmarkImportWorkflowRunner.bookmarkConfigurationFolderImportWasCancelled': 'Đã hủy nhập thư mục cấu hình dấu trang.',
	'providers.BookmarkImportWorkflowRunner.chooseABookmarkConfigurationFileOrFolder': 'Chọn tệp hoặc thư mục cấu hình dấu trang',
	'providers.BookmarkImportWorkflowRunner.chooseAWorkspaceRootForTheBookmarkConfigurationImport': 'Chọn thư mục gốc không gian làm việc sẽ nhận cấu hình dấu trang',
	'providers.BookmarkImportWorkflowRunner.chooseTheDestinationRootInAMultiRootWorkspace': 'Trong không gian làm việc nhiều thư mục gốc, hãy chọn thư mục gốc đích trước',
	'providers.BookmarkImportWorkflowRunner.codebookmarkConfiguration': 'Cấu hình CodeBookmark',
	'providers.BookmarkImportWorkflowRunner.importAndBind': 'Nhập và liên kết',
	'providers.BookmarkImportWorkflowRunner.importBookmarkConfigurationFor': 'Nhập cấu hình dấu trang cho {fileName}',
	'providers.BookmarkImportWorkflowRunner.importedAndBoundTheBookmarkConfigurationForImported': 'Đã nhập và liên kết cấu hình dấu trang: {fileName}; kết quả nhập: {formatBookmarkLevelSummary}.',
	'providers.BookmarkImportWorkflowRunner.importedBookmarkConfigurationsForScriptsFromTheFolderImported': 'Đã nhập cấu hình dấu trang của {imported} tệp lệnh từ thư mục cấu hình{skippedText}; kết quả nhập: {formatBookmarkLevelSummary}.',
	'providers.BookmarkImportWorkflowRunner.noConfigurationsInTheFolderWereImportedSkippedFailed': 'Không nhập được cấu hình nào trong thư mục (bỏ qua {skipped}, thất bại {failed}).',
	'providers.BookmarkImportWorkflowRunner.noImportableBookmarkConfigurationFilesWereFoundInThe': 'Không tìm thấy tệp cấu hình dấu trang có thể nhập trong thư mục đã chọn.',
	'providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindBeforeImportingA': 'Trước khi nhập một tệp cấu hình, hãy mở tệp lệnh cục bộ cần liên kết; ở chế độ không gian làm việc, bạn có thể chọn trực tiếp thư mục cấu hình.',
	'providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindOrOpenA': 'Hãy mở tệp lệnh cục bộ cần liên kết cấu hình dấu trang, hoặc mở một không gian làm việc rồi nhập thư mục cấu hình.',
	'providers.BookmarkImportWorkflowRunner.skippedFailed': '(bỏ qua {skipped}, thất bại {failed})',
	'providers.BookmarkImportWorkflowRunner.theActiveScriptScopeChangedBeforeTheImportCompleted': 'Phạm vi tệp lệnh đang hoạt động đã đổi trước khi nhập xong. Hãy mở lại tệp đích để xác nhận kết quả.',
	'providers.BookmarkImportWorkflowRunner.theCurrentScriptAlreadyHasBookmarksSoNoConfiguration': 'Tệp lệnh hiện tại đã có dấu trang nên không cần nhập cấu hình.',
	'providers.BookmarkImportWorkflowRunner.theWorkspaceScopeChangedBeforeTheImportCompletedReload': 'Phạm vi không gian làm việc đã đổi trước khi nhập xong. Hãy tải lại không gian làm việc để xác nhận kết quả.',
	'providers.BookmarkImportWorkflowRunner.unableToReadTheSelectedConfigurationPath': 'Không thể đọc đường dẫn cấu hình đã chọn: {errorMessage}',
	...
	'providers.CodeMarkerWorkflowController.theCurrentWorkspaceContainsMoreThanScriptsTheBackground': 'Không gian làm việc hiện tại có hơn {maxFiles} tệp lệnh. Nền chỉ quét {maxFiles} tệp đầu; các tệp còn lại sẽ tự đồng bộ TODO/FIXME/BUG khi được mở hoặc sửa.',
	...
	'repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderContainsMoreThanEntriesChoose': 'Thư mục cấu hình dấu trang có hơn {MAX_IMPORT_CONFIGURATION_ENTRIES} mục. Hãy chọn phạm vi nhập nhỏ hơn.',
	'repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderIsDeeperThanLevelsChoose': 'Thư mục cấu hình dấu trang sâu hơn {MAX_IMPORT_CONFIGURATION_DEPTH} cấp. Hãy chọn phạm vi nhập nhỏ hơn.',
	...
	'repository.BookmarkRepository.cancel': 'Hủy',
	'repository.BookmarkRepository.canTSaveBookmarksToFile': 'Không thể lưu dấu trang vào tệp',
	'repository.BookmarkRepository.configurationsHaveSourceFingerprintsThatDifferFromTheCurrent': '{fingerprintMismatches} cấu hình có dấu vân tay mã nguồn khác với tệp trong không gian làm việc hiện tại. Nếu tiếp tục, liên kết sẽ được tạo lại theo nội dung tệp hiện tại.',
	...
	'repository.BookmarkRepository.failedToImportABookmarkConfiguration': 'Không thể nhập cấu hình dấu trang ({configPath} -> {targetAbsolutePath}): {error}',
	'repository.BookmarkRepository.failedToImportTheWorkspaceBookmarkLayout': 'Không thể nhập bố cục dấu trang của không gian làm việc ({layoutPath}): {error}',
	'repository.BookmarkRepository.failedToInspectABookmarkConfigurationImportCandidate': 'Không thể kiểm tra ứng viên cấu hình dấu trang cần nhập ({configPath}): {error}',
	...
	'repository.BookmarkRepository.importAndBindAnyway': 'Vẫn nhập và liên kết',
	...
	'repository.BookmarkRepository.theSelectedConfigurationHasADifferentSourceFingerprintFrom': 'Cấu hình đã chọn có dấu vân tay mã nguồn khác với tệp lệnh hiện tại. Nếu tiếp tục, dấu trang bên trong sẽ được liên kết lại với tệp lệnh hiện tại.',
	'repository.BookmarkRepository.theSelectedFileIsNotAValidBookmarkConfiguration': 'Tệp đã chọn không phải cấu hình dấu trang hợp lệ',
	'repository.BookmarkRepository.theUserCancelledTheBookmarkConfigurationImport': 'Người dùng đã hủy nhập cấu hình dấu trang',
...
{bookmarksJson}
	...
	'util.PerformanceMonitor.perfDurationms': '[Hiệu năng] {name} thời gian-ms={toFixed}{fields}',
