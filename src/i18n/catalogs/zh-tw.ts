...
- linux：Linux`,
	...
	"commands.bookmarkCommands.bookmarkConfigurationImportWasCancelled": "已取消匯入書籤設定。",
	"commands.bookmarkCommands.failedToImportBookmarkConfiguration": "匯入書籤設定失敗：{errorMessage}",
	...
	"commands.exportCommand.bookmarkConfigurationSource": "書籤設定來源檔案",
	"commands.exportCommand.bookmarkConfigurationSourceExportCompletedFilesSucceededExportedFolder": "書籤設定來源檔案匯出完成：成功匯出 {exported} 個檔案{failedText}；匯出結果：{formatBookmarkLevelSummary}；資料夾：{fileName}。",
	"commands.exportCommand.bookmarkConfigurationSourceFileNotFound": "找不到書籤設定來源檔案",
	...
	"commands.exportCommand.codebookmarkConfigurationSources": "CodeBookmark-書籤設定來源檔案",
	...
	"commands.exportCommand.failedToExportBookmarkConfigurationSources": "匯出書籤設定來源檔案失敗：{errorMessage}",
	"commands.exportCommand.fileLineColumnLevelStatusLabelCode": "檔案,行號,欄號,階層,狀態,標籤,程式碼內容",
	"commands.exportCommand.filesFailed": "，{failed} 個檔案匯出失敗",
	...
	"commands.exportCommand.noneOfTheConfigurationSourceFilesForTheCurrent": "目前書籤所對應的設定來源檔案均不存在或無法讀取。",
	...
	"commands.exportCommand.selectAFolderForBookmarkConfigurationSources": "選擇書籤設定來源檔案的匯出資料夾",
	...
	"commands.exportCommand.thereAreNoBookmarkConfigurationSourceFilesToExport": "沒有可匯出的書籤設定來源檔案。",
	...
	"providers.BookmarkImportWorkflowRunner.anEntireBookmarkConfigurationFolderCanOnlyBeImported": "只有工作區模式支援匯入整個書籤設定資料夾。",
	"providers.BookmarkImportWorkflowRunner.bookmarkConfigurationFolderImportWasCancelled": "已取消匯入書籤設定資料夾。",
	"providers.BookmarkImportWorkflowRunner.chooseABookmarkConfigurationFileOrFolder": "選擇書籤設定檔或設定資料夾",
	"providers.BookmarkImportWorkflowRunner.chooseAWorkspaceRootForTheBookmarkConfigurationImport": "選擇要匯入書籤設定的工作區根資料夾",
	"providers.BookmarkImportWorkflowRunner.chooseTheDestinationRootInAMultiRootWorkspace": "多根工作區需要先選擇目標根資料夾",
	"providers.BookmarkImportWorkflowRunner.codebookmarkConfiguration": "CodeBookmark 設定",
	"providers.BookmarkImportWorkflowRunner.importAndBind": "匯入並綁定",
	"providers.BookmarkImportWorkflowRunner.importBookmarkConfigurationFor": "為 {fileName} 匯入書籤設定",
	"providers.BookmarkImportWorkflowRunner.importedAndBoundTheBookmarkConfigurationForImported": "已匯入並綁定 {fileName} 的書籤設定；匯入結果：{formatBookmarkLevelSummary}。",
	"providers.BookmarkImportWorkflowRunner.importedBookmarkConfigurationsForScriptsFromTheFolderImported": "已從設定資料夾匯入 {imported} 個指令碼的書籤設定{skippedText}；匯入結果：{formatBookmarkLevelSummary}。",
	"providers.BookmarkImportWorkflowRunner.noConfigurationsInTheFolderWereImportedSkippedFailed": "資料夾內的設定均未匯入（略過 {skipped} 個，失敗 {failed} 個）。",
	"providers.BookmarkImportWorkflowRunner.noImportableBookmarkConfigurationFilesWereFoundInThe": "所選資料夾中找不到可匯入的書籤設定檔。",
	"providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindBeforeImportingA": "匯入單一設定檔前，請先開啟要綁定的本機指令碼；在工作區模式下可直接選擇設定資料夾。",
	"providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindOrOpenA": "請先開啟要綁定書籤設定的本機指令碼，或開啟工作區後再匯入設定資料夾。",
	"providers.BookmarkImportWorkflowRunner.skippedFailed": "（略過 {skipped} 個，失敗 {failed} 個）",
	"providers.BookmarkImportWorkflowRunner.theActiveScriptScopeChangedBeforeTheImportCompleted": "匯入完成前，使用中的指令碼範圍已變更。請重新開啟目標指令碼以確認結果。",
	"providers.BookmarkImportWorkflowRunner.theCurrentScriptAlreadyHasBookmarksSoNoConfiguration": "目前指令碼已有書籤，無需匯入設定。",
	"providers.BookmarkImportWorkflowRunner.theWorkspaceScopeChangedBeforeTheImportCompletedReload": "匯入完成前，工作區範圍已變更。請重新載入工作區以確認結果。",
	"providers.BookmarkImportWorkflowRunner.unableToReadTheSelectedConfigurationPath": "無法讀取所選設定路徑：{errorMessage}",
	...
	"providers.CodeMarkerWorkflowController.theCurrentWorkspaceContainsMoreThanScriptsTheBackground": "目前工作區有超過 {maxFiles} 個指令碼；背景掃描只會處理前 {maxFiles} 個，其他指令碼會在開啟或編輯時自動同步 TODO/FIXME/BUG。",
	...
	"repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderContainsMoreThanEntriesChoose": "書籤設定資料夾有超過 {MAX_IMPORT_CONFIGURATION_ENTRIES} 個項目，請縮小匯入資料夾。",
	"repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderIsDeeperThanLevelsChoose": "書籤設定資料夾超過 {MAX_IMPORT_CONFIGURATION_DEPTH} 層，請縮小匯入資料夾。",
	...
	"repository.BookmarkRepository.cancel": "取消",
	"repository.BookmarkRepository.canTSaveBookmarksToFile": "無法將書籤儲存至檔案",
	"repository.BookmarkRepository.configurationsHaveSourceFingerprintsThatDifferFromTheCurrent": "有 {fingerprintMismatches} 個設定的原始程式碼特徵與目前工作區檔案不同。繼續會按目前檔案內容重新綁定。",
	"repository.BookmarkRepository.failedToCleanTheWorkspaceOrderAfterDeletingA": "刪除書籤設定後，清理工作區順序失敗（{scriptPath}）: {error}",
	"repository.BookmarkRepository.failedToImportABookmarkConfiguration": "匯入書籤設定失敗（{configPath} -> {targetAbsolutePath}）: {error}",
	"repository.BookmarkRepository.failedToImportTheWorkspaceBookmarkLayout": "匯入工作區書籤版面失敗（{layoutPath}）: {error}",
	"repository.BookmarkRepository.failedToInspectABookmarkConfigurationImportCandidate": "檢查書籤設定匯入候選項目失敗（{configPath}）: {error}",
	...
	"repository.BookmarkRepository.importAndBindAnyway": "仍然匯入並綁定",
	...
	"repository.BookmarkRepository.theSelectedConfigurationHasADifferentSourceFingerprintFrom": "所選設定的原始程式碼特徵與目前指令碼不同。繼續會將當中的書籤重新綁定至目前指令碼。",
	"repository.BookmarkRepository.theSelectedFileIsNotAValidBookmarkConfiguration": "所選檔案不是有效的書籤設定",
	"repository.BookmarkRepository.theUserCancelledTheBookmarkConfigurationImport": "使用者取消了書籤設定匯入",
...
{bookmarksJson}
	...
	"util.PerformanceMonitor.perfDurationms": "[效能] {name} 耗時毫秒={toFixed}{fields}",
