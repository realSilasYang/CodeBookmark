...
${iconSemanticCatalog}`,
	...
	'commands.bookmarkCommands.bookmarkConfigurationImportWasCancelled': '북마크 설정 가져오기를 취소했습니다.',
	'commands.bookmarkCommands.failedToImportBookmarkConfiguration': '북마크 설정을 가져오지 못했습니다: {errorMessage}',
	...
	'providers.BookmarkImportWorkflowRunner.anEntireBookmarkConfigurationFolderCanOnlyBeImported': '전체 북마크 설정 폴더는 작업 영역 모드에서만 가져올 수 있습니다.',
	'providers.BookmarkImportWorkflowRunner.bookmarkConfigurationFolderImportWasCancelled': '북마크 설정 폴더 가져오기를 취소했습니다.',
	'providers.BookmarkImportWorkflowRunner.chooseABookmarkConfigurationFileOrFolder': '북마크 설정 파일 또는 설정 폴더 선택',
	'providers.BookmarkImportWorkflowRunner.chooseAWorkspaceRootForTheBookmarkConfigurationImport': '북마크 설정을 가져올 작업 영역 루트 선택',
	'providers.BookmarkImportWorkflowRunner.chooseTheDestinationRootInAMultiRootWorkspace': '다중 루트 작업 영역에서는 먼저 대상 루트를 선택해야 합니다',
	'providers.BookmarkImportWorkflowRunner.codebookmarkConfiguration': 'CodeBookmark 설정',
	'providers.BookmarkImportWorkflowRunner.importAndBind': '가져와서 연결',
	'providers.BookmarkImportWorkflowRunner.importBookmarkConfigurationFor': '{fileName}의 북마크 설정 가져오기',
	'providers.BookmarkImportWorkflowRunner.importedAndBoundTheBookmarkConfigurationForImported': '북마크 설정을 가져와 연결했습니다: {fileName}. 가져온 결과: {formatBookmarkLevelSummary}.',
	'providers.BookmarkImportWorkflowRunner.importedBookmarkConfigurationsForScriptsFromTheFolderImported': '설정 폴더에서 스크립트 {imported}개의 북마크 설정을 가져왔습니다{skippedText}. 가져온 결과: {formatBookmarkLevelSummary}.',
	'providers.BookmarkImportWorkflowRunner.noConfigurationsInTheFolderWereImportedSkippedFailed': '폴더의 설정을 가져오지 못했습니다(건너뜀 {skipped}개, 실패 {failed}개).',
	'providers.BookmarkImportWorkflowRunner.noImportableBookmarkConfigurationFilesWereFoundInThe': '선택한 폴더에서 가져올 수 있는 북마크 설정 파일을 찾지 못했습니다.',
	'providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindBeforeImportingA': '설정 파일 하나를 가져오려면 먼저 연결할 로컬 스크립트를 여세요. 작업 영역 모드에서는 설정 폴더를 바로 선택할 수 있습니다.',
	'providers.BookmarkImportWorkflowRunner.openTheLocalScriptToBindOrOpenA': '북마크 설정에 연결할 로컬 스크립트를 열거나, 작업 영역을 연 뒤 설정 폴더를 가져오세요.',
	'providers.BookmarkImportWorkflowRunner.skippedFailed': '(건너뜀 {skipped}개, 실패 {failed}개)',
	'providers.BookmarkImportWorkflowRunner.theActiveScriptScopeChangedBeforeTheImportCompleted': '가져오기가 끝나기 전에 활성 스크립트 범위가 바뀌었습니다. 대상 스크립트를 다시 열어 결과를 확인하세요.',
	'providers.BookmarkImportWorkflowRunner.theCurrentScriptAlreadyHasBookmarksSoNoConfiguration': '현재 스크립트에 이미 북마크가 있어 설정을 가져올 필요가 없습니다.',
	'providers.BookmarkImportWorkflowRunner.theWorkspaceScopeChangedBeforeTheImportCompletedReload': '가져오기가 끝나기 전에 작업 영역 범위가 바뀌었습니다. 작업 영역을 다시 로드해 결과를 확인하세요.',
	'providers.BookmarkImportWorkflowRunner.unableToReadTheSelectedConfigurationPath': '선택한 설정 경로를 읽을 수 없습니다: {errorMessage}',
	...
	'commands.exportCommand.bookmarkConfigurationSource': '북마크 설정 원본 파일',
	'commands.exportCommand.bookmarkConfigurationSourceExportCompletedFilesSucceededExportedFolder': '북마크 설정 원본 파일 내보내기가 완료되었습니다. 파일 {exported}개 성공{failedText}. 내보낸 결과: {formatBookmarkLevelSummary}. 폴더: {fileName}.',
	'commands.exportCommand.bookmarkConfigurationSourceFileNotFound': '북마크 설정 원본 파일을 찾을 수 없음',
	...
	'commands.exportCommand.codebookmarkConfigurationSources': 'CodeBookmark-북마크 설정 원본 파일',
	...
	'commands.exportCommand.failedToExportBookmarkConfigurationSources': '북마크 설정 원본 파일을 내보내지 못했습니다: {errorMessage}',
	'commands.exportCommand.fileLineColumnLevelStatusLabelCode': '파일,줄 번호,열 번호,단계,상태,레이블,코드 내용',
	'commands.exportCommand.filesFailed': ', 파일 {failed}개 내보내기 실패',
	...
	'commands.exportCommand.noneOfTheConfigurationSourceFilesForTheCurrent': '현재 북마크에 해당하는 설정 원본 파일이 모두 없거나 읽을 수 없습니다.',
	...
	'commands.exportCommand.selectAFolderForBookmarkConfigurationSources': '북마크 설정 원본 파일을 내보낼 폴더 선택',
	...
	'commands.exportCommand.thereAreNoBookmarkConfigurationSourceFilesToExport': '내보낼 북마크 설정 원본 파일이 없습니다.',
	...
	'providers.CodeMarkerWorkflowController.theCurrentWorkspaceContainsMoreThanScriptsTheBackground': '현재 작업 영역의 스크립트가 {maxFiles}개를 넘습니다. 백그라운드에서는 앞의 {maxFiles}개만 검색하며 나머지는 열거나 편집할 때 TODO/FIXME/BUG가 자동 동기화됩니다.',
	...
	'repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderContainsMoreThanEntriesChoose': '북마크 설정 폴더의 항목이 {MAX_IMPORT_CONFIGURATION_ENTRIES}개를 넘습니다. 더 작은 폴더를 가져오세요.',
	'repository.BookmarkConfigurationImportScanner.theBookmarkConfigurationFolderIsDeeperThanLevelsChoose': '북마크 설정 폴더가 {MAX_IMPORT_CONFIGURATION_DEPTH}단계보다 깊습니다. 더 작은 폴더를 가져오세요.',
	...
	'repository.BookmarkRepository.cancel': '취소',
	'repository.BookmarkRepository.canTSaveBookmarksToFile': '북마크를 파일에 저장할 수 없습니다',
	'repository.BookmarkRepository.configurationsHaveSourceFingerprintsThatDifferFromTheCurrent': '설정 {fingerprintMismatches}개의 소스 지문이 현재 작업 영역 파일과 다릅니다. 계속하면 현재 파일 내용에 맞춰 다시 연결합니다.',
	...
	'repository.BookmarkRepository.failedToImportABookmarkConfiguration': '북마크 설정을 가져오지 못했습니다({configPath} -> {targetAbsolutePath}): {error}',
	'repository.BookmarkRepository.failedToImportTheWorkspaceBookmarkLayout': '작업 영역 북마크 레이아웃을 가져오지 못했습니다({layoutPath}): {error}',
	'repository.BookmarkRepository.failedToInspectABookmarkConfigurationImportCandidate': '가져올 북마크 설정 후보를 검사하지 못했습니다({configPath}): {error}',
	...
	'repository.BookmarkRepository.importAndBindAnyway': '그래도 가져와서 연결',
	...
	'repository.BookmarkRepository.theSelectedConfigurationHasADifferentSourceFingerprintFrom': '선택한 설정의 소스 지문이 현재 스크립트와 다릅니다. 계속하면 그 안의 북마크를 현재 스크립트에 다시 연결합니다.',
	'repository.BookmarkRepository.theSelectedFileIsNotAValidBookmarkConfiguration': '선택한 파일은 유효한 북마크 설정이 아닙니다',
	'repository.BookmarkRepository.theUserCancelledTheBookmarkConfigurationImport': '사용자가 북마크 설정 가져오기를 취소했습니다',
...
{bookmarksJson}
	...
	'util.PerformanceMonitor.perfDurationms': '[성능] {name} 소요 시간ms={toFixed}{fields}',
