...
{bookmarksJson}
	...
	'util.PerformanceMonitor.booleanTrue': 'sí',
	'util.PerformanceMonitor.changed': 'Número de cambios',
	'util.PerformanceMonitor.extensionHostHeapMiB': 'Memoria dinámica del Extension Host (MiB)',
	'util.PerformanceMonitor.failed': 'Errores',
	'util.PerformanceMonitor.files': 'Número de archivos',
	'util.PerformanceMonitor.perfDurationms': '[Rendimiento] {name} tiempo real={toFixed} ms{fields}',
	...
	'util.PerformanceMonitor.workspaceCodeMarkerScanDetails': '[Rendimiento] {name}\n  Tiempo real: total {totalMs} ms; detección de archivos {discoveryMs} ms; procesamiento {processingMs} ms\n  Archivos: candidatos {files}; encontrados {discoveredFiles}; documentos abiertos {openedDocuments}; datos leídos {readMiB} MiB\n  Tiempo acumulado de tareas paralelas (no se suma al tiempo real): consultas {discoveryQueryMs} ms ({discoveryQueries}); apertura {openMs} ms; lectura {readMs} ms; análisis exacto {exactScanMs} ms\n  Resultado: descartados por el prefiltro {prefilteredFiles} ({prefilterRate}%); análisis exactos {exactScans} ({exactRate}%); modificados {changedFiles}',
	...
	"commands.bookmarkCommands.portablePackageImportWasCancelled": "Se canceló la importación de la configuración portátil de marcadores.",
	"commands.bookmarkCommands.failedToImportPortablePackage": "No se pudo importar la configuración portátil de marcadores: {errorMessage}",
	"commands.exportCommand.chooseCurrentFolderRoot": "Elige la raíz del área de trabajo que se usará como carpeta actual",
	"commands.exportCommand.chooseCurrentFolderRootDescription": "No hay ningún script activo. Elige la raíz que quieres exportar",
	"commands.exportCommand.exportPortablePackage": "Exportar configuración portátil de marcadores",
	"providers.PortableImportWorkflowRunner.append": "Añadir",
	"providers.PortableImportWorkflowRunner.appendDescription": "Conserva los marcadores existentes y combina los marcadores y el diseño del paquete",
	"providers.PortableImportWorkflowRunner.overwrite": "Sobrescribir",
	"providers.PortableImportWorkflowRunner.overwriteDescription": "Sustituye los marcadores y el diseño de los scripts coincidentes por el contenido del paquete",
	"providers.PortableImportWorkflowRunner.chooseImportMode": "Elige cómo importar los marcadores",
	"providers.PortableImportWorkflowRunner.existingBookmarksDetected": "Algunos scripts de destino ya contienen marcadores",
	"providers.PortableImportWorkflowRunner.import": "Importar",
	"providers.PortableImportWorkflowRunner.choosePackage": "Elige un archivo de configuración portátil de marcadores",
	"providers.PortableImportWorkflowRunner.openWorkspaceOrScript": "Abre una carpeta, un área de trabajo o un script local antes de importar una configuración portátil de marcadores.",
	"providers.PortableImportWorkflowRunner.packageIndexInconsistent": "El índice de scripts de la configuración portátil de marcadores está incompleto.",
	"providers.PortableImportWorkflowRunner.noUniqueTargets": "No se pudo asociar de forma inequívoca ningún script local; hay conflictos de coincidencia en {count} scripts. Abre la carpeta o el script correspondiente e inténtalo de nuevo.",
	"providers.PortableImportWorkflowRunner.scopeChanged": "El ámbito de los marcadores cambió durante la importación. Vuelve a abrir la carpeta o el script de destino e inténtalo de nuevo.",
	"providers.PortableImportWorkflowRunner.completed": "Configuración portátil de marcadores importada: {imported} scripts, {updated} marcadores de nivel superior actualizados, {removed} eliminados, {mergeConflicts} conflictos de combinación y {matchingConflicts} conflictos de coincidencia. Resultado actual: {formatBookmarkLevelSummary}.",
	"repository.BookmarkConfigurationCatalog.portableExchangeRecordIsInvalid": "El registro de intercambio de la configuración portátil no es válido o no se puede leer",
	"providers.BookmarkConfigurationManagementController.portableExchangeRecords": "{deletedPortableExchanges} registros de intercambio de configuraciones portátiles",
	"providers.BookmarkConfigurationManagerWebview.portableExchangeRecord": "Registro de intercambio de configuración portátil",
	"providers.BookmarkConfigurationManagerWebview.portableExchangeRecords": "Registros de intercambio de configuraciones portátiles",
	"providers.BookmarkConfigurationManagerWebview.portableExchangeRecordsRemovalEffect": "Registros de intercambio: {count} (al eliminarlos se conservan los marcadores actuales, pero se pierden las asignaciones de identidad y las bases de combinación de tres vías de esas series)",
	"providers.BookmarkConfigurationManagerWebview.exchangeIdentity": "Serie de intercambio: {value}",
	"providers.BookmarkConfigurationManagerWebview.exchangeScope": "Ámbito vinculado: {value}",
	"providers.BookmarkConfigurationManagerWebview.exchangeRevision": "Última revisión: {value}",
	"providers.BookmarkConfigurationManagerWebview.exchangeMappings": "{scripts} asignaciones de scripts · {bookmarks} de marcadores · {bases} bases de combinación",
	"providers.BookmarkConfigurationManagerWebview.exchangePurpose": "Conserva identidades, reimportaciones sin duplicados y combinaciones de tres vías al compartir entre dispositivos",
	"providers.BookmarkConfigurationManagerWebview.exchangeUpdated": "Registro de intercambio actualizado: {date}",
	"providers.PortableImportWorkflowRunner.invalidPackage": "El archivo seleccionado no es una configuración portátil de marcadores compatible. Puede estar dañado, tener un formato incorrecto o haberse creado con una versión más reciente de CodeBookmark.",
