/**
 * 锁定有意公开给命令和测试的导出符号数量，防止内部实现无意扩大 API 面。
 * 脚本围绕“锁定有意公开给命令和测试的导出符号数量”构造最小输入，同时覆盖正常路径和明确拒绝的边界。
 */
...
const directTestSeams = [
	...
	'models/SerializedBookmarkTree.ts#mergeSerializedBookmarksWithIdMap',
