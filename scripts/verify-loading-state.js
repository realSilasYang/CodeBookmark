...
assert.match(refreshBody, /const refresh = \(\) => this\.viewRefreshCoordinator\.refresh\(/)
assert.match(refreshBody, /if \(!reloadsDisk\) return refresh\(\)/)
assert.match(refreshBody, /this\.viewMutationBarrier\.runAfterSettled\(/)
