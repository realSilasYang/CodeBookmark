...
assert.equal(commands.get('codebookmark.deleteBookmark')?.title, '删除书签')
assert.equal(commands.get('codebookmark.ai.generateSkip')?.title, '✦　生成书签')
assert.equal(commands.get('codebookmark.ai.openSettings')?.title, '⚙　代码书签 AI 参数')
